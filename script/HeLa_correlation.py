...
#######ribo only data
def ribo_only(GSMinput,ribonput,outdir,status):
...
def main(args2):
    ...
    current_parameters(args2.ribonput, args2.GSMinput,args2.outdir)
    ribo_dedup=ribo_only(args2.GSMinput,args2.ribonput,args2.outdir,status="dedup")
    ...
    ribo_CPM.to_csv(args2.outdir + "/ribo_hela_cpm.csv")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--ribonput", help='all analysis folder',default='/scratch/users/yliu5/HELA_eletter/zenodo/ribo_file/')
